...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    description:
      "3 điểm nên kiểm tra trước khi chốt homestay ở trung tâm Ninh Kiều: vị trí, loại phòng, giá và cách liên hệ nhanh.",
    ...
    content: [
      ...
      "Nếu lịch đi đã rõ, cách nhanh nhất vẫn là nhắn Zalo hoặc gọi trực tiếp để homestay kiểm tra phòng trống và phản hồi ngay.",
    ],
  },
];
